...
(async () => {
  ...
  await fs.writeFile("diabetes-mellitus-type-ii-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diabetes-mellitus-type-ii-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
